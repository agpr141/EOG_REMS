"""
script to manually identify eye movements during a pre-specified REM episode & analyse
...
peak_range_start, peak_range_end, clean_e1, clean_e2, e1_peaks, e1_troughs, e2_peaks, e2_troughs, channel_crossings, \
bad_episode_list, good_episode_list, e1_uvd, e2_uvd = manual_peak_detect(episode_to_analyse, rem_episodes_e1,
                                                                         rem_episodes_e2, bad_episode_list,
                                                                         good_episode_list, episode_to_analyse)
start_art, end_art = plot_episode(e1_peaks, e2_peaks, e1_troughs, e2_troughs, e1_uvd, e2_uvd, episode_to_analyse)
